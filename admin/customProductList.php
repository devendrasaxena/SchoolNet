...
$response_result = $productObj->getProductList();

//$objPage->_total = $response_result['total'];
//$batchInfoArr = $response_result['result'];
?>
<div class="breadcrumbBgNone breadcrumbPadder">
    <div class="col-md-6 col-sm-6 text-left">Manage Custom Product</div>
    <div class="col-md-6 col-sm-6 text-right"><a href='addCustomProduct.php' class="btn btn-primary ">Add Custom Product</a>&nbsp;&nbsp;<a href='productshop.php' class="btn btn-primary ">Shop</a></div>
</div>
<div class="clear"></div>
                            ...
                            <table class="table table-border dataTable table-fixed">
                                <thead class="fixedHeader">
                                    <tr class="col-sm-12 padd0">
                                        ...
                                        <th class="col-sm-2 text-center">Master</th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr class="col-sm-12 padd0">
                                            ...
                                            <td class="col-sm-2 text-center"><?php echo $productName; ?></td>
               
                                             <td class="col-sm-2 text-center" <?php echo $activeClass; ?>><?php echo $status; ?></td>
                                            <td class="col-sm-2 text-center">
                                                <a class="edit" href="<?php echo "addCustomProduct.php?pid=" . base64_encode($value['id']); ?>"> <i class="fa fa-edit"></i> Edit</a></td>
                                        </tr>
                                    <?php $i++;
                                    } ?>
                                    <tr>
