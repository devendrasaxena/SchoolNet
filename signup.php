...
if(client_reg_id==5){
	header('location:dseu_signup.php');
	exit;	
}
...
?> 
 <section class="scrollable" style="top: 0px;">
<div class="bgImg bgRegImg" >
 <img src="images/reg_bg.png" class="relative bgDivImg bgRegDivImg" alt="" />
	  <div class="reg_mainDiv">
		<div class="relative">
		<div class="midDiv">
		<div class="regDiv">
 ...
 <input type="hidden" name="registration_form" value="1">	  
		...
		<div class="loginRegBox regBox relative">
		  ...
		  <div class="form-Div">
			...
			<div class="form-Div">
			  ...
			  <div class="inputDiv">
				<!--<input type="password" id="reg_password" name="reg_password" class="inputText password" value="" tabindex="3" type="password" data-required="true" data-required-message="Please enter password."  maxlength="15" />-->
				...
				<!--<input type="password" id="reg_password" name="reg_password" class="inputText password" value="" data-minlength="[6]" data-maxlength="[15]"  tabindex="3" type="password" data-required="true"  maxlength="12" data-regexp="^(?=.*[A-Za-z])(?=.*\d)(?=.*[@$!%*#?&])[A-Za-z\d@$!%*#?&]{6,15}$" data-regexp-message="Password should be between 6 to 15 characters, at least 1 letter, 1 number and 1 special character."  />-->
		...
		<img src="images/group-2-copy.svg" class="responsive reg_iconImg" alt=""/>
		 <img src="images/reg_left.png" class="responsive reg_leftImg" alt=""/>
		<img src="images/reg_right.png" class="responsive reg_rightImg" alt=""/>
		</form>
		 </div>
    </div>
  </div>
