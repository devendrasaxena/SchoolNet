...
$event = getWebinarBBBListByEventId($web_id);

//echo "<pre>ss";print_r($event);
...
$num_seats_total = $event->num_seats_total;
$num_seats_avail = $event->num_seats_avail;
...
$webdescription = $event->description;
$trainer_url = $event->trainer_url;
if($client_id==73){}else{
$course_code = $event->course_code;
$course_edge_id = $event->course_edge_id;
$topic_edge_id = $event->topic_edge_id;
$chapter_edge_id = $event->chapter_edge_id;
 ...
 <section class="padder">
   <div class="row-centered">
	<div class="col-sm-10 col-xs-12 col-centered">
     ...
     <form id="eventForm" action="../bigBlueButton/edit-meeting.php" method="post" data-validate="parsley" autocomplete="off">
	<div class="row">
            ...
            <div class="panel-body padd20">
             ...
             <div class="col-sm-12 col-xs-12 col-centered">
			    <div class="col-sm-6 col-xs-6 text-left" style="padding-left:0px;">
			    	<input type="hidden" name="txtEventId" value="<?php echo $web_id ?>">
			...
			<div class="clear"></div> 
			 ...
			 <div id="divTime" class="input-group bootstrap-timepicker timepicker">
				  ...
				  Max Seat <span class="required">*</span> </label>	<input type='hidden' id='isScheduleOnWiziq' name='isScheduleOnWiziq' value='YeS'>			 
					<input class="form-control input-lg" name="textMaxSeat" id="textMaxSeat" type="text" value="0<?php //echo $num_seats_total;?>" data-type="number" onblur="maxSeat(this.id,'maxErr');trimSpaces(this.id);" maxlength="3" placeholder="max seat"/><label class="required" id="maxErr">	 </label>		
				  </div>
			  </div>
			 </div>
