...
<div class="bgImg bgLoginImg" style="background-color: transparent;
    background-repeat: no-repeat;
    background-image: url(images/bg.jpg);
    background-size: cover;
    background-position: 50% 50%;height:100vh">
 <!--<img src="images/bg.jpg" class="relative bgDivImg bgLoginDivImg" alt=""  />-->
	  <div class="login_mainDiv">
		<div class="relative">
		<div class="midDiv">
		 <div class="row">
		   <div class="col-sm-8 col-xs-6 pull-left " ></div>
