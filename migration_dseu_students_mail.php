		...
		if($sno>472){
			...
			if($userData!=''){ 
			 ...
			 echo $key+1;echo "  "; echo $userData->email_id;echo "<br>";
			  mailSenderUser1($userData->roll_no,$userData->loginid, $userData->password,$userData->name,$userData->mobile,$userData->email_id,$userData->center_name,$userData->role_definition_id,$userData->region,$userData->user_id);
		   }
		}
	}
}
