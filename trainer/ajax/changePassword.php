...
?> <div class="divider"  style="border-top:solid thin #ccc"></div>
				...
				<div class="col-sm-12 col-xs-12  paddLeft0">
                  ...
                  <input class="form-control input-lg" name="oldPassword" id="oldPassword" type="password"   maxlength="15"  placeholder="Enter old password"  autocomplete="nope" data-minlength="[6]" data-maxlength="[15]"  />
				...
				<div class="col-sm-6 padd0">
                  ...
                  <label >  <?php echo $language[$_SESSION['language']]['new_password'];?> <span class="required">*</span></label>
                   <input type = "password" name="fld_password" id="newPassword"  class="form-control input-lg " value=""  data-required="true"  data-regexp="<?php echo $passRegexp;?>" data-regexp-message="<?php echo $passRegexpMsg;?>" maxlength="15"   autocomplete="nope" placeholder="="<?php echo $language[$_SESSION['language']]['new_password'];?>"/>
