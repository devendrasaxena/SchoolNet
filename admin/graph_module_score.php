...
$graphRowData = $graphObj->getModuleScore($options);
	...
	<section class="marginBottom5 serachformDiv <?php if($_SESSION['role_id']==7){?> <?php echo 'hide'; ?> <?php }?>" >
		 ...
		 <div class="col-xs-3 col-sm-3 col-md-3 col-lg-6 text-left paddLeft0">
			...
			<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 text-right paddRight0">
				<button type="submit"  class="btn btn-red" id="btnSave"  title=" <?php echo $language[$_SESSION['language']]['search'] ?><?php echo $language[$_SESSION['language']]['module_score'] ?>"
				 style="margin-top:0px"> 
				 <?php echo $language[$_SESSION['language']]['search']; ?></button>
				
				<a class="btn btn-sm btn-red btnwidth40" href="graph_module_score.php" name="refresh" title=" <?php echo $language[$_SESSION['language']]['refresh']; ?> " style="margin-top:0px"> <i class="fa fa-refresh"></i></a>
			</div>
   ...
   <?php  //}?>
       ...
       <section class="panel panel-default">
		...
		echo '<script>var graphData = []</script>';  
			...
			graphData.push(<?php echo $value['score'] == ""? 0 :  round($value['score']) ;?>);
