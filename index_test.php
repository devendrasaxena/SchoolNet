...
//echo "<pre>";print_r($jsonArr['ROLE_NAME']);
//$role_id=7;
//echo $region_admin=  (JSON_DATA && $role_id==$jsonArr['ROLE_NAME'][0]['id'])? $jsonArr['ROLE_NAME'][0]['value']:'Region Admin'; 
	  ...
	  <form class="login-form" id="loginForm" action="" method="post" enctype="multipart/form-data" autocomplete="off" onsubmit="return  loginValidation('login_email','login_password')">
		...
		<div class="loginRegBox loginBox relative">
		  ...
		  <div class="btnDiv">
		   ...
		   <a class="taketest text-right underLine <?php echo $hide;?>" href="signup.php" tabindex="4">Sign up |</a>   <a class="taketest text-right underLine" href="forgotPassword.php" tabindex="5">Forgot password?</a></div>
