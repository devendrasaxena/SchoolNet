 ...
 <section class="padder reportList"> 
	...
	<div id="insReport" class="tab-pane fade in active">
	 <?php // if(count($all_center_list_arr) > 0){?>
		<form id="serachform" name="serachform" method="GET"  class="form-horizontal form-centerReg" action="users_report.php" >
			 ...
			 <select name="role_id" id="role_id" class="form-control" >
			   ...
			   <option value="" <?php  echo $optiondisabled ;?>><?php echo $language[$_SESSION['language']]['user_type']; ?> </option>
					...
					$optionSelected = ($role_id == 'All') ? "selected" : "";
						  echo '<option value="All" '.$optionSelected.'>All</option>';
			   ?>
                     <option class="usertype_options" value="7" <?php   echo $options['role_id'] == 7?'selected':'' ?> ><?php echo "CEO"; ?> </option>
	  ...
	  <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5 text-left paddLeft0">
		...
		<div class="result_list"></div>
			...
			<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 text-right paddRight0">
				...
				<a class="btn btn-sm btn-red btnwidth40" href="users_report.php" name="refresh" title=" <?php echo $language[$_SESSION['language']]['refresh']; ?> " style="margin-top:0px"> <i class="fa fa-refresh"></i></a>
			</div>
			 <div class="clear" style="margin-top:10px;">&nbsp;</div>
		  ...
		  <table class="table table-border dataTable table-fixed">
			...
			<thead  class="fixedHeader">
			  ...
			  <th class="col-sm-2 text-left textUpper">
				  <a href="users_report.php?region_id=<?php echo $region_id;?>&center_id=<?php echo $center_id;?>&district_id=<?php echo $district_id;?>&tehsil_id=<?php echo $tehsil_id;?>&role_id=<?php echo $role_id;?>&sort=u.first_name&dir=<?php echo $dir?>" class="th-sortable"><?php echo $language[$_SESSION['language']]['name']; ?>
						<span class="th-sort"> 
							<?php 
			   ...
			   <th class="col-sm-3 text-left textUpper"><a href="users_report.php?region_id=<?php echo $region_id;?>&center_id=<?php echo $center_id;?>&district_id=<?php echo $district_id;?>&tehsil_id=<?php echo $tehsil_id;?>&role_id=<?php echo $role_id;?>&sort=u.email_id&dir=<?php echo $dir?>" class="th-sortable"><?php echo $language[$_SESSION['language']]['login_id']; ?>
						<span class="th-sort"> 
							<?php 
			   ...
			   <th class="col-sm-2 text-left textUpper"><a href="users_report.php?region_id=<?php echo $region_id;?>&center_id=<?php echo $center_id;?>&district_id=<?php echo $district_id;?>&tehsil_id=<?php echo $tehsil_id;?>&role_id=<?php echo $role_id;?>&sort=u.created_date&dir=<?php echo $dir?>" class="th-sortable"><?php echo $language[$_SESSION['language']]['joined']; ?>
						<span class="th-sort"> 
							<?php 
			  ...
			  <th class="col-sm-2 text-left textUpper">
			  	<a href="users_report.php?region_id=<?php echo $region_id;?>&center_id=<?php echo $center_id;?>&district_id=<?php echo $district_id;?>&tehsil_id=<?php echo $tehsil_id;?>&role_id=<?php echo $role_id;?>&sort=state&dir=<?php echo $dir?>" class="th-sortable">
			   ...
			   <th class="col-sm-2 text-left textUpper"><a href="users_report.php?region_id=<?php echo $region_id;?>&center_id=<?php echo $center_id;?>&district_id=<?php echo $district_id;?>&tehsil_id=<?php echo $tehsil_id;?>&role_id=<?php echo $role_id;?>&sort=last_visit&dir=<?php echo $dir?>" class="th-sortable">
			   ...
			   <th class="col-sm-1 text-left textUpper"><a href="users_report.php?region_id=<?php echo $region_id;?>&center_id=<?php echo $center_id;?>&district_id=<?php echo $district_id;?>&tehsil_id=<?php echo $tehsil_id;?>&role_id=<?php echo $role_id;?>&sort=u.is_active&dir=<?php echo $dir?>" class="th-sortable">
...
<script>
     ...
     /*  $(document).ready(function () {
             $(".export-report").click(function(e){
                e.preventDefault();
                var url = 'users_report.php?report_type=export';
